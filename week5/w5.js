...
class BlogEntry {
  constructor(book, pYear, author, description, rate, rYear, like, comment) {
    this.book = {};
    this.book.S = book;
    // this.book = {};
    // this.book.S = book;
